public class Ivanov {
     ...
     */
    private static int calculate(int a, int b, int c, int d) { // Method1
     ...
     */
    private static boolean checkTwoNumbers(int first, int second) { //Method2
     ...
     */
    private static void printIsPositive(int variable) { //Method3
     ...
     */
    private static boolean isNegative(int variable) {   //Method4
        return (variable < 0);
    }
     ...
     */
    private static void printWelocome(String name) {    //Method5
     ...
     */
    private static boolean isLeapYear(int year) {   //Method6
